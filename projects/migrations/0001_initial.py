    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_rated', to='projects.project')),
                ('design', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='design_rated', to='projects.project')),
                ('usability', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usability_rated', to='projects.project')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
